...
export const setMantenimientos = (prev,fechaRealizacion,id) => prev.map(m => 
  m.id === id ? { ...m, fechaRealizacion, estado: 'Completado' } : m
);

export const registrarRealizacion = async (id,mantenimientosService,mostrarExito,mostrarError) => {
    try {
  ...
  export const editarMantenimiento = (mantenimiento,setMantenimientoEditando,setMostrarModal) => {
  ...
  export const guardarMantenimiento = async (
    formData,mantenimientoEditando,mantenimientosService,mostrarExito,setMostrarModal,setMantenimientoEditando,mostrarError) => {
    try {
