  ...
  const [permisosEquipo] = useState({
    ...
    return (
        <div className="w-full flex flex-col gap-3 p-0" >
            ...
            >
                 <div className="w-full flex flex-col gap-3 p-0" style={{ width: '100%' }}>
                    ...
                    <div>
                        ...
                        {permisosEquipo.gestionEquipo && (
                            <Button 
                                ...
                                tooltip={!permisos.gestionEquipo ? "No tienes permisos para esta acción" : ""}
                            />)}
                            <Button 
                                ...
                                tooltip={!permisos.gestionMantenimientos ? "No tienes permisos para esta acción" : ""}
                            />
                            <Button 
                                ...
                                tooltip={!permisos.gestionUsuarios ? "Solo disponible para Administradores" : ""}
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        <h3 className="w-full text-lg font-semibold mb-3 border-b pb-2">Operaciones de Consulta</h3>
